...
def order_home(request):
    products_in_order = ProductInOrder.objects.filter(is_active=True)
    orders_display = Order.objects.filter()
    return render(request, 'order/order_home.html', locals())
        ...
        if form.is_valid():
            ...
            for name, value in data.items():
                if name.startswith("product_in_basket_"):
                    ...
                    ProductInOrder.objects.get_or_create(product=product_in_basket.product, nmb=product_in_basket.nmb,
